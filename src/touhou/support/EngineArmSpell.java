...
public class EngineArmSpell extends GameObject implements PhysicsBody {
    ...
    public EngineArmSpell() {
        super();
        animation = new Animation(Sprite.getSprites("assets/images/sphere-bullets/", 4), 10);
